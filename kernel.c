...
void kernel_main(void) 
{
	...
	while (true) {
		...
		terminal_writestring("Hallo Kernel Welt!\n");
		terminal_setcolor(VGA_COLOR_LIGHT_MAGENTA);
		terminal_writestring("Ich bin hellmagenta!\n");
		terminal_setcolor(VGA_COLOR_LIGHT_GREEN);
		terminal_writestring("Dies ist ein Betriebssystem!\n");
	}
